...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
            <h1 className='text-3xl font-medium'>Những bác sĩ bên chúng tôi</h1>
            <p className='sm:w-1/3 text-center text-sm'>Chuyên nghiệp, trình độ, tận tâm, nhiệt huyết phục vụ khách hàng.</p>
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-[#EAEFFF] text-gray-600 px-12 py-3 rounded-full mt-10'>Xem thêm</button>
        </div>
