...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Dịch vụ đa năng</h1>
            <p className='sm:w-1/3 text-center text-sm'>Mang tới khách hàng với những trải nghiệm dịch vụ tốt nhất</p>
