...
const News = () => {
  const { news } = useContext(AppContext); // Lấy dữ liệu từ AppContext
  const navigate = useNavigate();

  const handleServiceClick = (id) => {
    navigate(`/new-details/${id}`); // Chuyển đến trang chi tiết dịch vụ
  };

  return (
    <div>
      <p className='text-gray-600'>Danh sách tin tức</p>
